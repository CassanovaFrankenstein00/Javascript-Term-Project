$(document).ready(function(){
    ...
    $("#dungeon").on("mouseover",function(){
        document.getElementById("message").innerHTML="<em>Dungeon Master</em> A dungeon crawler\
        where the player uses the arrow keys to travel therough the dugeon collecting jewels.\
        Make it to the portal at rhe end of the dungeon to win!.";
    })
